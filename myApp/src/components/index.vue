<template>
    <div class="index_web" @mouseleave="leave()">
        ...
        <iframe class="ifr" src="http://blog.sina.com.cn/yanqk" frameborder="0"></iframe>
...
export default {
  ...
  data() {
    return {
      ...
      count:0,
      show_tip_msg:
        "大家好，这是mint的个人项目，只用于练习用途，此页面为我的个人博客，会不定期更新一下前后端知识"
    };
  },
  methods: {
    tip_click() {
    ...
    loginOut() {
      ...
      sessionStorage.removeItem("getLogin");
    }
  }
};
</script>
